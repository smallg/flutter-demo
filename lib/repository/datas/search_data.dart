class SearchData {
  ...
  SearchData.fromJson(Map<String, dynamic> json) {
    ...
    if (json["datas"] is List) {
      datas = json["datas"] == null
          ? null
          : (json["datas"] as List)
              .map((e) => SearchListData.fromJson(e))
              .toList();
    }
  ...
  static List<SearchData> fromList(List<Map<String, dynamic>> list) {
    return list.map(SearchData.fromJson).toList();
  }
...
class SearchListData {
  ...
  static List<SearchListData> fromList(List<Map<String, dynamic>> list) {
    return list.map(SearchListData.fromJson).toList();
  }
